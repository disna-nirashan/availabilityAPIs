...
class SearchTest {
	...
	@Test
	public void test_results_sorted(){
	...
	@Test
	public void test_invalid_location_key(){
		var result = roomsController.getRoomsAvailability(
				10000,
				3,
				2,
	...
	@Test
	public void test_past_fromdate(){
		var result = roomsController.getRoomsAvailability(
				1,
				3,
				2,
	...
	@Test
	public void test_todate_past_than_fromdate(){
		var result = roomsController.getRoomsAvailability(
				1,
				3,
				2,
	...
	@Test
	public void test_results_one_adult(){
	...
	@Test
	public void test_invalid_passegnger_count(){
		var result = roomsController.getRoomsAvailability(
				1,
				3,
				3,
...
@Test
	public void test_results_one_adult_and_one_child(){
	...
	public void test_results_one_adult_and_three_child(){
	...
	public void test_results_one_adult_and_four_child(){
	...
	@Test
	public void test_valied_locationKey_but_no_hotels_or_rooms_configured(){
		var result = roomsController.getRoomsAvailability(
				10,
				1,
				0,
